...
def get_historical_forex_data(
    ...
    granularity [int] : Default value S5 | "S5", "S10", "S15", "S30", "M1", "M2", "M4", "M5", "M10", "M15", "M30", "H1", "H2", "H3", "H4", "H6", "H8", "H12", "D", "W", "M"\n
    ...
    ** period takes precendence next. If specified from_date, to_date is ignored.
    ...
    Returns
    ----------
    A list of JSON Objects following the HistoricalForexDTO schema.
    """
