...
import { TickerSearchDTO, getTickerSearchAutocomplete } from 'endpoints/clients/autocomplete';
...
export function TickerSearch(props: {
    ...
    const [options, setOptions] = React.useState<TickerSearchDTO[]>([]);
