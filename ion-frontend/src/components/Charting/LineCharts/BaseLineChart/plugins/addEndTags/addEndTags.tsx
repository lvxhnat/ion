...
export const addEndTags = (props: {
    ...
    d3.selectAll("#end-tags")
        ...
        .data(props.dataY)
        .join("path")
        .attr("d", (d, i) => { return `M ${1} ${props.y(d)} l 6,-6 h 50 v 12 h -24 l -26,0` })
        .attr("transform", `translate(${LINECHARTCONFIGS.DEFAULT_WIDTH - LINECHARTCONFIGS.DEFAULT_MARGIN_RIGHT},0)`)
