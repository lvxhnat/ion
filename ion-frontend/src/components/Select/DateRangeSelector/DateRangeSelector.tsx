...
export const DateRangeSelectionBox = styled('div')<{ selected?: boolean }>(({ theme }) => ({
    zIndex: 10,
    height: 25,
    padding: 5,
    display: 'flex',
...
export default function DateRangeSelector(props: { onClick?: (date: Date) => void }) {
    ...
    return (
        <DateRangeWrapper>
            <DateRangeSelectionBox
                id="YTD"
                style={{
                    backgroundColor: period === 'YTD' ? ColorsEnum.darkGrey : ColorsEnum.warmgray2,
                }}
                onClick={handleClick}
            >
            ...
            <DateRangeSelectionBox
                id="1Y"
                style={{
                    backgroundColor: period === '1Y' ? ColorsEnum.darkGrey : ColorsEnum.warmgray2,
                }}
                onClick={handleClick}
            >
            ...
            <DateRangeSelectionBox
                id="2Y"
                style={{
                    backgroundColor: period === '2Y' ? ColorsEnum.darkGrey : ColorsEnum.warmgray2,
                }}
                onClick={handleClick}
            >
            ...
            <DateRangeSelectionBox
                id="5Y"
                style={{
                    backgroundColor: period === '5Y' ? ColorsEnum.darkGrey : ColorsEnum.warmgray2,
                }}
                onClick={handleClick}
            >
            ...
            <DateRangeSelectionBox
                id="10Y"
                style={{
                    backgroundColor: period === '10Y' ? ColorsEnum.darkGrey : ColorsEnum.warmgray2,
                }}
                onClick={handleClick}
            >
